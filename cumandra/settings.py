"""
Django settings for cumandra project.
...
SECRET_KEY = 'django-insecure-asxqxt*_o4ykvjohm(p8_0s4dgkli$&$keei67cmz3&)9y0yl@'
...
WSGI_APPLICATION = 'cumandra.wsgi.application'

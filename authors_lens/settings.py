...
CORS_ALLOWED_ORIGINS = ["http://localhost:5173", "http://127.0.0.1:*", "https://*.vercel.app", "https://*.netlify.app"]

CSRF_TRUSTED_ORIGINS = ["http://localhost:5173", "http://127.0.0.1:*", "https://*.vercel.app", "https://*.netlify.app"]
